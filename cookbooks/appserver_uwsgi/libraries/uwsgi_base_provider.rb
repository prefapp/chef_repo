              ...
              action :create do
               ...
               private 
                ...
                def configure_service(run_options)
                    ...
                    supervisor_service "python-#{new_resource.name}" do        
                        stdout_logfile "/var/log/supervisor/python_#{new_resource.name}.log"
                        stderr_logfile "/var/log/supervisor/python_#{new_resource.name}.err"
                        command command
                        startsecs 10
                        stopsignal "QUIT"
                        stopasgroup true
